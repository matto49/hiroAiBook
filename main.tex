...
\usepackage[a5paper,inner=13.5mm,outer=10.5mm,top=13mm,bottom=15mm]{geometry}
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage{booktabs}
\usepackage{array}
...
% A5 小册子正文密度：B 档在可读性与纸张成本之间取平衡。
\makeatletter
\renewcommand\normalsize{%
  \@setfontsize\normalsize{7.5pt}{9.1pt}%
}
\renewcommand\small{%
  \@setfontsize\small{6.8pt}{8.1pt}%
}
\makeatother
\AtBeginDocument{\normalsize}

% 公式、图表与编号列表保留呼吸感，但避免在 A5 上留下过大的空白。
